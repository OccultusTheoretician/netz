...
**Drafted 2026-07-29 UTC against HEAD e5e4e0f.** AUTHORSHIP: drafted by the desk's assistant under the operator's direction; read in full and adopted by the operator on 2026-09-14. Every external citation below was verified against the source on 2026-07-29 by live retrieval; the C2PA paper is cited to the version its authors analyzed.
...
**Adoption note, 2026-09-14.** The provenance banner carried since 2026-07-29 is replaced by the AUTHORSHIP line at the head of this document on the operator's adoption; the earlier bytes stand in the commit history. No amendment text changes.
