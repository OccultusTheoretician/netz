...
function netzTab(id, btn){
  ...
  if(tb && tb.getBoundingClientRect().top < 0){ tb.scrollIntoView({behavior:'smooth',block:'start'}); }
    ...
    if "LEDGER" in tu:
        ...
        h_ledger, h_kkr, h_report = "", "", "here"
    desknav = ("""<nav class="desknav"><div class="desknav-in"><a class="home" href="index.html"><img src="crow_mark.svg" alt=""><span>NebelKr&auml;he</span></a><div class="dn-links"><a class="{H_report}" href="report.html">Report</a><a class="{H_ledger}" href="ledger.html">Ledger</a><a class="{H_kkr}" href="kkr.html">Forecasts</a><a href="register.html">Register</a><a href="KriegForeKaster_compendium.html">Compendium</a><a href="https://github.com/OccultusTheoretician/netz">GitHub</a><a class="cta-min" href="index.html">Home</a></div></div></nav>""").replace("{H_report}",h_report).replace("{H_ledger}",h_ledger).replace("{H_kkr}",h_kkr)
