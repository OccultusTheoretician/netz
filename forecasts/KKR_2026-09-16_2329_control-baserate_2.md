...
2355 issued all-time across 16 forecaster arms · 1953 open (61 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `control/baserate`:** 800 issued · 747 open · 53 resolved · 25 hits / 28 misses · **Brier 0.267** against its own base rate 47.2% (climatological 0.249) · **skill -0.071**.
...
|---|---|---|---|---|---|---|---|---|---|
| control/baserate | 800 | 747 | 53 | 25 | 28 | 0.267 | 47.2% | 0.249 | -0.071 |
...
| manual/opus-5/unattested | 273 | 266 | 7 | 5 | 2 | 0.137 | 71.4% | 0.204 | +0.329 |
