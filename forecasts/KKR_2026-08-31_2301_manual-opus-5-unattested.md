...
1156 issued all-time across 14 forecaster arms · 995 open (83 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/opus-5/unattested`:** 142 issued · 139 open · 3 resolved · 1 hits / 2 misses · **Brier 0.141** against its own base rate 33.3% (climatological 0.222) · **skill +0.366** · under 30 resolved, this is noise.
