...
491 issued all-time across 14 forecaster arms · 435 open (0 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/sonnet-5/unattested`:** 34 issued · 34 open · nothing resolved yet — this arm earns a score at its first resolution.
