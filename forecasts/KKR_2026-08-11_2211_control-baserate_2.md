...
507 issued all-time across 14 forecaster arms · 451 open (0 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `control/baserate`:** 62 issued · 62 open · nothing resolved yet — this arm earns a score at its first resolution.
...
|---|---|---|---|---|---|---|---|---|---|
| control/baserate | 62 | 62 | 0 | — | — | not computed | — | — | — |
