...
2263 issued all-time across 16 forecaster arms · 1861 open (61 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/fable-5.1/unattested`:** 113 issued · 111 open · 2 resolved · 0 hits / 2 misses · **Brier 0.156** against its own base rate 0.0% (climatological 0.000) · **skill —** · under 30 resolved, this is noise.
...
|---|---|---|---|---|---|---|---|---|---|
| control/baserate | 750 | 697 | 53 | 25 | 28 | 0.267 | 47.2% | 0.249 | -0.071 |
