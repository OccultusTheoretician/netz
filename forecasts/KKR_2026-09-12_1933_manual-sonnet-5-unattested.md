...
1970 issued all-time across 16 forecaster arms · 1634 open (77 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/sonnet-5/unattested`:** 218 issued · 186 open · 32 resolved · 16 hits / 16 misses · **Brier 0.224** against its own base rate 50.0% (climatological 0.250) · **skill +0.105**.
