...
1327 issued all-time across 15 forecaster arms · 1062 open (31 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/fable-5.1/unattested`:** 7 issued · 7 open · nothing resolved yet — this arm earns a score at its first resolution.
