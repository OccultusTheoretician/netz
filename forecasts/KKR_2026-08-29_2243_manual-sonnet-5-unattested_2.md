...
Window: this run · source: battle_report_2026-08-29_1537.md · forecaster: manual/sonnet-5/unattested · 1 accepted / 0 rejected by validation gate · 1 rated below 35% (base-rate discipline)

## I. VALIDATED PROJECTIONS

| id | p | deadline | domain | statement | resolves on |
|---|---|---|---|---|---|
| KKR-20260829-76 | 20% | 2026-09-16 | economics/markets | The Federal Open Market Committee will announce a lower federal funds target range at the conclusion of its September 15-16, 2026 meeting than the range set in July 2026. | TRUE if the Federal Reserve statement released 2026-09-16 sets a federal funds target range below the range set after the July 2026 meeting; FALSE if held or raised. |
...
1121 issued all-time across 14 forecaster arms · 960 open (79 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.
