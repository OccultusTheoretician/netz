...
1844 issued all-time across 16 forecaster arms · 1508 open (54 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/fable-5.1/unattested`:** 68 issued · 68 open · nothing resolved yet — this arm earns a score at its first resolution.
...
|---|---|---|---|---|---|---|---|---|---|
| control/baserate | 573 | 535 | 38 | 18 | 20 | 0.280 | 47.4% | 0.249 | -0.124 |
