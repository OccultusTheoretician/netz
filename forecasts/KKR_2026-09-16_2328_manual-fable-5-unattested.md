...
2310 issued all-time across 16 forecaster arms · 1908 open (61 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/fable-5/unattested`:** 258 issued · 251 open · 7 resolved · 7 hits / 0 misses · **Brier 0.178** against its own base rate 100.0% (climatological 0.000) · **skill —** · under 30 resolved, this is noise.
