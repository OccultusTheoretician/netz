...
1572 issued all-time across 16 forecaster arms · 1307 open (89 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/fable-5.1/unattested`:** 38 issued · 38 open · nothing resolved yet — this arm earns a score at its first resolution.
