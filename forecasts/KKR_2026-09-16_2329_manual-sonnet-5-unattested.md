...
2360 issued all-time across 16 forecaster arms · 1958 open (61 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/sonnet-5/unattested`:** 252 issued · 209 open · 43 resolved · 21 hits / 22 misses · **Brier 0.207** against its own base rate 48.8% (climatological 0.250) · **skill +0.172**.
...
| manual/sonnet-5/unattested | 252 | 209 | 43 | 21 | 22 | 0.207 | 48.8% | 0.250 | +0.172 |
