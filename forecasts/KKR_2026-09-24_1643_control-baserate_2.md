...
2808 issued all-time across 17 forecaster arms · 2266 open (170 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `control/baserate`:** 982 issued · 865 open · 85 resolved · 50 hits / 35 misses · **Brier 0.327** against its own base rate 58.8% (climatological 0.242) · **skill -0.352**.
...
|---|---|---|---|---|---|---|---|---|---|
| control/baserate | 982 | 865 | 85 | 50 | 35 | 0.327 | 58.8% | 0.242 | -0.352 |
