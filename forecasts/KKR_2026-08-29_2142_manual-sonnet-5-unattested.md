...
1061 issued all-time across 14 forecaster arms · 900 open (79 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/sonnet-5/unattested`:** 113 issued · 105 open · 8 resolved · 5 hits / 3 misses · **Brier 0.174** against its own base rate 62.5% (climatological 0.234) · **skill +0.257** · under 30 resolved, this is noise.
