...
967 issued all-time across 14 forecaster arms · 877 open (75 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `control/baserate`:** 208 issued · 200 open · 8 resolved · 1 hits / 7 misses · **Brier 0.125** against its own base rate 12.5% (climatological 0.109) · **skill -0.143** · under 30 resolved, this is noise.
...
|---|---|---|---|---|---|---|---|---|---|
| control/baserate | 208 | 200 | 8 | 1 | 7 | 0.125 | 12.5% | 0.109 | -0.143 |
