...
2816 issued all-time across 17 forecaster arms · 2274 open (170 past deadline — run `python kkr.py --resolve`). **No pooled score is published** — a Brier score belongs to one forecaster; an average across arms is nobody's record.

**This arm — `manual/sonnet-5/unattested`:** 314 issued · 250 open · 59 resolved · 31 hits / 28 misses · **Brier 0.238** against its own base rate 52.5% (climatological 0.249) · **skill +0.047**.
